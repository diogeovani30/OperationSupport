...
<body>
    ...
    <div class="container-login100" style="background-image: url('img/bg-01.jpg'); background-size: cover;">
        <div class="wrap-login100">
            ...
            <span class="login100-form-title p-b-34 p-t-23">
                Registration Form
            </span>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <main class="form-registration">
                        <form action="/register" method="post" class="login100-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input" class="form-floating">
                                <input class="input100" type="text" name="username"
                                    ...
                                    placeholder="Name" required value="{{ old('username') }}">
                                <span class="focus-input100"></span>
                                @error('username')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <small class="d-block text-center mt-3" class="container-login100-form-btn"
                            style="color:#ffffff;">Already Registered ? <a href="/login">Login</a></small>
                    </main>
                </div>
            </div>
        </div>
